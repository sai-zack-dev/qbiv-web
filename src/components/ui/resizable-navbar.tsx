...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn("fixed inset-x-0 z-100 w-full", className)}
    >
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <div className="p-2.5 bg-[#2256D5] dark:bg-white rounded-full">
        <img
        src="/logo-white.png"
        alt="logo"
        width={20}
      ...
      <span className="font-medium text-black dark:text-white">QBIV</span>
    </a>
  );
};
